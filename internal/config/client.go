...
func defaultClientConfig() ClientConfig {
	return ClientConfig{
		...
		StreamQueueInitialCapacity:            1024,
		...
		ARQWindowSize:                         1000,
		ARQInitialRTOSeconds:                  0.3,
		ARQMaxRTOSeconds:                      2.0,
		ARQControlInitialRTOSeconds:           0.25,
		ARQControlMaxRTOSeconds:               1.5,
		...
		ARQDataNackInitialDelaySeconds:        0.15,
