...
| `UDP_READERS` | Number of UDP reader goroutines. | Values `<= 0` use an auto default capped at `8`. |
| `DNS_REQUEST_WORKERS` | Number of workers processing parsed DNS requests. | Values `<= 0` use an auto default capped at `32`. |
